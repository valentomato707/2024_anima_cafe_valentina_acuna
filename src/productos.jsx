export const productos = [
  ...
  { categoria: "Cafetería", precio: "$160", stock: 0, nombre: "Americano" },
  { categoria: "Panadería", precio: "$190", stock: 5, nombre: "Pan de nuez" },
  { categoria: "Panadería", precio: "$160", stock: 1, nombre: "Pan de campo" },
  { categoria: "Dulces", precio: "$180", stock: 0, nombre: "Tiramisú" },
  { categoria: "Dulces", precio: "$60", stock: 50, nombre: "Cheesecake" },
